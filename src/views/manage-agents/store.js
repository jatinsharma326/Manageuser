  ...
  actions: {
    ...
    uploadTravelAgents: ({ commit, dispatch }, payload) => {
      ...
      return dispatch(
        ...
        .then((data) => {
          if (!data.ok)
            fail(data.message || "Failed to upload travel agent file");
          return data;
        })
        .catch((err) => {
    ...
    addCompanyEmployee: ({ commit, dispatch }, payload) => {
      ...
      return dispatch(
        ...
        .then((data) => {
          if (!data.ok)
            fail(data.message || "Failed to add Travel Agent Employee");
          return data;
        })
        .catch((err) => {
    ...
    editCompanyEmployee: ({ commit, dispatch }, payload) => {
      ...
      return dispatch(
        ...
        .then((data) => {
          if (!data.ok)
            fail(data.message || "Failed to edit Travel Agent Employee");
          return data;
        })
        .catch((err) => {
