<template>
    <div class="agentsWrapper primary-background-color">
        ...
        <v-row
            class="px-6 manageagents-search-bar"
            justify="center"
            align="center"
        >
            ...
            >
                ...
                >
                    ...
                    <template v-slot:actionButtons>
                        <template>
                            <v-btn
                                @click="openChangelogsModal(company)"
                                icon
                                color="secondary"
                                text
                            ...
                            <v-btn
                                @click="openInformationModal(company)"
                                color="primary"
                                text
                            >
                                View
                        ...
                        <v-list class="gradeListWrapper">
                            ...
                            <v-list-item>
                                ...
                                <v-list-item-content>
                                    ...
                                    <v-list-item-subtitle
                                        >Iata Code</v-list-item-subtitle
                                    >
                                </v-list-item-content>
                            </v-list-item>
        ...
        >
            ...
            <template v-slot:modalSubtitle>
                <div
                    class="tertiary-font-color"
                    v-if="selectedCompanyInfo.business_types"
                >
                ...
                <v-tooltip left>
                    <template v-slot:activator="{ on, attrs }">
                        <v-btn
                            ...
                            small
                            color="error"
                            @click="openUploadlogsModal(true)"
                            v-bind="attrs"
                            v-on="on"
                        >
...
export default {
    ...
    methods: {
        ...
        deleteTravelAgentEntry(entry) {
            if (
                window.confirm("Do you really want to Delete the Travel Agent?")
            ) {
                this.openLoaderDialog();
            ...
            if (value) {
                ...
                this.spawnProcess().then((data) => {
                    ...
                    if (data.ok) {
                        ...
                        this.openSnackbar({
                            text:
                                "Another Upload Process is running. Please try again later",
                        });
                    }
                });
            } else {
        ...
        downloadSampleFileFunc(formData) {
            return new Promise((res, rej) => {
                ...
                link.href =
                    "https://global-destinations-bucket.s3-us-west-2.amazonaws.com/travelAg.xlsx";
