				...
				<div class="upload-container">
					...
					<div class="stepper-section">
						<div class="stepper-content-wrapper">
							<div v-if="!uploadMode" class="dropzone-container">
								<div class="file-selection-area">
									...
									<button @click.stop="triggerFileUpload" class="action-btns filled-button">
										Select file
									</button>
									...
									<div class="download-file-section">
										...
										<button @click.stop="downloadSampleFile" class="action-btns outlined-button">
											XLSX
										</button>
										<a class="download-anchor" ref="download-anchor-sample" href="" target="_blank"
											>Download</a
										>
									</div>
								</div>
	...
	export default {
		...
		methods: {
			...
			triggerFileUpload() {
				...
				console.log("Test Console File state when selecting a file", this.file);
			},
			downloadSampleFile() {
				let anchor = this.$refs["download-anchor-sample"];
				console.log(anchor);

				//Make a GET call to get Sample file URL
